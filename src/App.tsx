...
function App() {
  ...
  return (
    <><DarkModeSwitch /><div className='light:bg-slate-200 dark:bg-tb'>
      <header className="App-header dark">
        <img src={logo} className="App-logo" alt="logo" />
        <p className='dark:text-gray-600 light:text-tb'>
          Edit <code>src/App.tsx</code> and save to reload.
        </p>
        <a
          className="App-link dark:text-gray-600 light:text-tb"
...
<form>
   <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
       ...
       <div className="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
           ...
           <textarea id="editor" className="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required></textarea>
       </div>
   </div>
